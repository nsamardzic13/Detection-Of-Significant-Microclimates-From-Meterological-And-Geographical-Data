...
autocorrelation_weather_condition = 'vedro'
autocorrelation_difference = 0.20   # x% differene
...
def get_dates(data, value):
    ...
    ret_list = tmp_ret_list['Date'].value_counts().nlargest(7).index.tolist()
    return ret_list
...
def main():
    ...
    autocorrelation_days = get_dates(df_data_pgz, autocorrelation_weather_condition)
